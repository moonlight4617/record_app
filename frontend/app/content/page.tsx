        ...
        <Tabs defaultValue="add" className="space-y-4">
          <TabsList className="grid w-full grid-cols-4 gap-4 bg-gray-200 p-1">
            <TabsTrigger
              value="add"
              setTab={setTab}
              className={`flex items-center justify-center ${tab == "add" ? "bg-white" : null}`}
            >
            ...
            <TabsTrigger
              value="view"
              setTab={setTab}
              className={`flex items-center justify-center ${tab == "view" ? "bg-white" : null}`}
            >
            ...
            <TabsTrigger
              value="best"
              setTab={setTab}
              className={`flex items-center justify-center ${tab == "best" ? "bg-white" : null}`}
            >
            ...
            <TabsTrigger
              value="watchlist"
              setTab={setTab}
              className={`flex items-center justify-center ${tab == "watchlist" ? "bg-white" : null}`}
            >
              <Bookmark className="mr-2 h-4 w-4" />
              ウォッチリスト
            </TabsTrigger>
