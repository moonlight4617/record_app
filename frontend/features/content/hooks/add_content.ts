...
import { ContentDataType, UseAddContentReturn, AddContentResult } from "../types/content_type"
...
export const useAddContent = (): UseAddContentReturn => {
  ...
  const addContent = async (content: ContentDataType): Promise<AddContentResult> => {
